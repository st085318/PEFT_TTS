...
(HYDRA_FULL_ERROR=1 find_unused_parameters=True python fastpitch_finetune_speaker.py \
--config-name=fastpitch_align_LORA.yaml \
...
+exp_manager.wandb_logger_kwargs.name="LORA" \
